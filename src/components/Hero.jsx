...
const  Hero = () => {
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
      ...
      viewport={{once:true}}
      className='inline-flex items-center gap-2 border border-gray-300 border-gray-300 p-1.5 pr-4 rounded-full'>
      ...
      <span className=' bg-gradient-to-r from-[#5044E5] to-[#4d8CEA] bg-clip-text text-transparent gap-1 '> digital</span> impact.
      </motion.h1>
      <motion.p

...
const ContactUs = () => {
   const onSubmit = async (event) => {
    ...
    formData.append("access_key", "28720ac5-a98d-4f7d-a327-06f9f63d5c63");
    try {
    ...
    >
      ...
      onSubmit={onSubmit} className="grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full">
        ...
        <div className="sm:col-span-2">
            ...
            <textarea name="message" rows={8} id="" placeholder="Enter your message" className="w-full p-3 text-sm outline-none rounded-lg border border-ray-300 dark:border-gray-600" required></textarea>
        </div>

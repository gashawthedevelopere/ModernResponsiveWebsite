...
const Services = ({title,desc}) => {
    const servicesData=[
        ...
        },
        {
            ...
            description:'We can help you create a marketing strategy that drives result.',
  ...
  return (
    ...
    id='services' className='relative fle flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
